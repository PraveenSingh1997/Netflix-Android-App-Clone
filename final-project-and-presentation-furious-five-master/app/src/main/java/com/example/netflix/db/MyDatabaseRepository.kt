...
import com.example.netflix.PeopleFragment
import java.util.*
...
class MyDatabaseRepository constructor(private val fragment: PeopleFragment)
{
...
//    Keep track of person ID
    ...
    //fun fetchPersons(): LiveData<List<UUID>> = myDao.fetchPersons()
